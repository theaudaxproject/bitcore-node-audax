...
var BASE_PACKAGE = {
  description: 'A full Audax node build with Bitcore',
  repository: 'https://github.com/user/project',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-audax': 'git+https://git@github.com/theaudaxproject/bitcore-lib-audax',
    'bitcore-node-audax': 'git+https://git@github.com/theaudaxproject/bitcore-node-audax'
  }
};
