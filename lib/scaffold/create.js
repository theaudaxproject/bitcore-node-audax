...
var BASE_PACKAGE = {
  ...
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-zcash': 'git+ssh://git@github.com:zcashblockchain/bitcore-lib-zcash',
    'bitcore-node-zcash': 'git+ssh://git@github.com:zcashblockchain/bitcore-node-zcash'
  }
};
