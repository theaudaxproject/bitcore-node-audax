...
function checkConfigVersion2(fullConfig) {
  ...
  if (!datadirUndefined || addressDefined || dbDefined) {
    ...
    console.warn('\nConfiguration file is not compatible with this version. \n' +
                 'A reindex for audaxd is necessary for this upgrade with the "reindex=1" audax.conf option. \n' +
                 'There are changes necessary in both audax.conf and bitcore-node.json. \n\n' +
