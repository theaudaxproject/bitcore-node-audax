...
function checkConfigVersion2(fullConfig) {
  ...
  if (!datadirUndefined || addressDefined || dbDefined) {
    ...
    console.warn('\nConfiguration file is not compatible with this version. \n' +
                 'A reindex for komodod is necessary for this upgrade with the "reindex=1" komodo.conf option. \n' +
                 'There are changes necessary in both komodo.conf and bitcore-node.json. \n\n' +
